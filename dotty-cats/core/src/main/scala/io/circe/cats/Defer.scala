...
object Defer {
  def apply[F[_]] given (F: Defer[F]): Defer[F] = F

  given as Defer[Function0] = io.circe.cats.instances.Function0Instance
  given [I] as Defer[[x] =>> I => x] = io.circe.cats.instances.Function1InstanceR[I]
}
