...
import io.circe.cats.{Alternative, Applicative, CoflatMap, Eval, Monad, Show, Traverse, TraverseFilter}
import io.circe.cats.data.Chain._
import io.circe.cats.kernel.{Eq, Hash, Monoid, Order, PartialOrder}
import io.circe.cats.kernel.instances.StaticMethods
